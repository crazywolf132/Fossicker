...
import fdoom.screen.SplashMenu;
...
public class Game {
	...
	public static boolean continous = true;
	
	public static final String NAME = "Fossickers Doom"; // This is the name on the application window
	public static final Version VERSION = new Version("2.6");
	...
	public static void main(String[] args) {
		...
		if(Network.autoclient)
			...
			setMenu(new SplashMenu()); //sets menu to the title screen.
