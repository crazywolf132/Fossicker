...
import fdoom.screen.EndGameDisplay;
import fdoom.screen.LevelTransitionDisplay;
import fdoom.screen.PauseDisplay;
import fdoom.screen.PlayerDeathDisplay;
...
public class Updater extends Game {
	...
	public static double dayCount = gameTime / 64800;
