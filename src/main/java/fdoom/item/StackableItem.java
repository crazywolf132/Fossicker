...
public class StackableItem extends Item {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new StackableItem("Grass Fibers", new Sprite(21, 5, Color.get(-1, 10, 40, 50))));
		items.add(new StackableItem("Stick", new Sprite(20, 5, Color.get(-1, Color.hex("#b5651d"), 532, 532))));
