...
public class Color {
	...
	*/
	...
	/*
		To provide a method to the madness, all methods ending in "Color" are copies of the methods of the same name without the "Color" part, except they convert the given value to 24bit Java RGB rather than the normal, fdoom 8-bit total RGB (that really only goes up to 216).
	...
	*/
	...
	/// this turns a 0-216 combined fdoom color into a 24-bit r,g,b color. AKA: rgbByte -> rgbInt
	...
	/// this takes a 24 bit color, and turns it into an 8-bit color fdoom sprites use. AKA: rgbInt -> rgbByte
