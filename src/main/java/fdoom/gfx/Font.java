...
public class Font {
	...
	public static int DEFAULT_BACKGROUND_COLOR = Color.get(Color.rgb(60, 63, 65), Color.rgb(60, 63, 65), Color.rgb(60, 63, 65), Color.rgb(60, 63, 65));
	public static int DEFAULT_BORDER_COLOR = Color.get(-1, 1, Color.rgb(60, 63, 65), 445);
